  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-36 px-12 py-6">
      <h2 className="text-center text-2xl font-semibold text-neutral-950">
        Диаграммы сгорания проекта {name}
      </h2>
          ...
          {sprints &&
            sprints.map((sprint) => (
              <Link
                ...
                className="flex h-[70px] w-[170px] items-center justify-center rounded-xl border border-neutral-700 px-3 py-2 text-neutral-700 transition-all duration-150 hover:scale-105"
              >
                {sprint.name}
              </Link>
            ))}
